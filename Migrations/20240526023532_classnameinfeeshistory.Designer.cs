...
namespace BLOG.WEB.Migrations
{
    ...
    [Migration("20240526023532_classnameinfeeshistory")]
    partial class classnameinfeeshistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BLOG.WEB.Models.Domain.FeesHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("TransportFees")
                        .HasColumnType("float");

                    b.Property<bool>("TransportFesspaid")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BLOG.WEB.Models.Domain.FeesHistory", b =>
                {
                    b.HasOne("BLOG.WEB.Models.Domain.ClassName", "classNames")
                        .WithMany()
                        .HasForeignKey("ClassNameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BLOG.WEB.Models.Domain.Fees", "Feeses")
                        .WithMany()
                        .HasForeignKey("FeesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BLOG.WEB.Models.Domain.Person", "Persons")
                        .WithMany()
